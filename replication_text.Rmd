...
# Replication of figures 1, 3, and 4 of "Gene expression patterns associated with caste and reproductive status in ants: worker-specific genes are more derived than queen-specific ones" by Feldmeyer, Elsner, and Foitzik, 2013
...
#b <- filter(a, queenfertile_p<0.05 & queenfertile_fold>2 & queeninfertile_p<0.05 & queeninfertile_fold>2 & queenforager_p<0.05 & queenforager_fold>2 | infertileforager_p<0.05 & infertileforager_fold>2 & queeninfertile_p<0.05 & queeninfertile_fold< -2 & fertileinfertile_p<0.05 & fertileinfertile_fold< -2 | queenforager_p<0.05 & queenforager_fold< -2 & infertileforager_p<0.05 & infertileforager_fold< -2 & fertileforager_p<0.05 & fertileforager_fold< -2 | fertileinfertile_p<0.05 & fertileinfertile_fold>2 & queenfertile_p<0.05 & queenfertile_fold< -2 & fertileforager_p<0.05 & fertileforager_fold>2)

#b <- filter(a, queenfertile_p<0.05 & queenfertile_fold>0 & queeninfertile_p<0.05 & queeninfertile_fold>0 & queenforager_p<0.05 & queenforager_fold>0 | infertileforager_p<0.05 & infertileforager_fold>0 & queeninfertile_p<0.05 & queeninfertile_fold<0 & fertileinfertile_p<0.05 & fertileinfertile_fold<0 | queenforager_p<0.05 & queenforager_fold<0 & infertileforager_p<0.05 & infertileforager_fold<0 & fertileforager_p<0.05 & fertileforager_fold<0 | fertileinfertile_p<0.05 & fertileinfertile_fold>0 & queenfertile_p<0.05 & queenfertile_fold<0 & fertileforager_p<0.05 & fertileforager_fold>0)
...
## This table shows "Number of significantly up-regulated genes (FDR-P < 0.05; fold change >2) in the focal caste in comparison withthe other castes and the number of pair-specific genes (genesup-regulated in only this specific comparison) with the corre-sponding percentage in parentheses"
...
###
qfert <- filter(qfert, !ID %in% fertq & !ID %in% qinfert & !ID %in% infertq & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
fertq<- filter(fertq, !ID %in% qfert & !ID %in% qinfert & !ID %in% infertq & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
qinfert <- filter(qinfert, !ID %in% qfert & !ID %in% fertq & !ID %in% infertq & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
infertq <- filter(infertq, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
qfor <- filter(qfor, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
forq <- filter(forq, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
fertinfert <- filter(fertinfert, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% forq & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
infertfert <- filter(infertfert, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
fertfor <- filter(fertfor, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% forfert & !ID %in% infertfor & !ID %in% forinfert)
forfert <- filter(forfert, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% infertfor & !ID %in% forinfert)
infertfor <- filter(infertfor, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% forinfert)
forinfert <- filter(forinfert, !ID %in% qfert & !ID %in% fertq & !ID %in% qinfert & !ID %in% infert & !ID %in% qfor & !ID %in% forq & !ID %in% fertinfert & !ID %in% infertfert & !ID %in% fertfor & !ID %in% forfert & !ID %in% infertfor)
